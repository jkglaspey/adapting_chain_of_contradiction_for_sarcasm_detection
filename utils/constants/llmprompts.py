CoCPrompts = [
    ...
    "Based on the conversation history, say ONLY the label 'sarcastic' or 'not sarcastic'. If you think it is sarcastic, reply 'sarcastic'. If you think it is not sarcastic, reply 'not sarcastic'. Do not include any other text or symbols."
]
